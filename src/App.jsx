  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/aesthetic-orators" element={<Orators />} />
        <Route path="/about-aesthetic" element={<AboutOralMed />} />
        <Route path="/aesthetic-event-schedule" element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/aesthetic-conference-tracks/"  element={<RotatingLogos />} />
