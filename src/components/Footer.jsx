...
const Footer = () => {
  const nav_links = [
    { name: "About", link:"/about-aesthetic" },
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/aesthetic-conference-tracks/"},
    { name: "Orators", link: "/aesthetic-orators"},
    { name: "Schedule", link:   "/aesthetic-event-schedule"},
  ...
  return (
    <div className="flex flex-col rounded-t-2xl md:flex-row md:justify-between bg-accent/70 px-4 sm:px-6 md:px-12 py-8 md:py-10 text-white gap-10 md:gap-6 items-start md:items-stretch">
      ...
      <div className="w-full md:w-1/4 flex flex-col mt-[10px] items-center md:items-start text-center md:text-left gap-4">
        <div className=" pt-10 p-4 rounded-xl">
          ...
          />
          <br />
        <p style={{}} className="text-center ml-[-15px]">
   “Advancing Research into Regenerative Aesthetics”
        </p>
