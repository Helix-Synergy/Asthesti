...
const BrochureDownload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        link.href = "/AESTHETICA.pdf";
        link.setAttribute("download", "AESTHETICA.pdf");
  ...
  return (
    <div className="w-full  mx-auto justify-center items-center text-center mt-20 md:mt-24">
      <div
        className={`${banner_style} w-full mx-auto brochure-banner`}
        style={{
          backgroundImage: "url('https://wallpapers.com/images/hd/4k-office-background-tw1rq5nwu7z2ou3w.webp')",
