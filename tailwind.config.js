...
module.exports = {
  ...
  colors: {
  /* Brand colors – UPDATED to Rose (no name changes) */
  one: "#D97F7F",        // Primary brand (rgb 217,127,127)
  accent: "#D97F7F",
  greenBrand: "#D97F7F", // kept name to avoid breaking CSS

  /* Backgrounds */
  primary: "#140B0B",    // Deep warm dark
  secondary: "#1D1111",  // Soft dark section
  coal: "#0B0505",       // Near black

  /* Supporting / UI */
  sky: "#F2CACA",        // Light rose highlight
  orange: "#E8B1B1",     // Soft rose accent
  lightGreen: "#FAEDED", // Soft rose background (name kept)

  /* Track / row colors */
  track: {
    odd: "#2A1414",
    even: "#1F0E0E",
    green: "#D97F7F",    // replaced green with rose
  },
},
